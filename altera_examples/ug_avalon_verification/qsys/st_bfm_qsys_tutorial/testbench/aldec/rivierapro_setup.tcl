...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/verbosity_pkg.sv"              
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/avalon_utilities_pkg.sv"       
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_sc_fifo.v"       
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv"  
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_st_source_bfm.sv"
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_reset_source.sv" 
  vlog  "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_clock_source.sv" 
