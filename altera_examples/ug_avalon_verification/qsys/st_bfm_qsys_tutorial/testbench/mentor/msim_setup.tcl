...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "st_bfm_qsys_tutorial_tb"
}
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/verbosity_pkg.sv"              
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/avalon_utilities_pkg.sv"       
  vlog     "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_sc_fifo.v"       
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv"  
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_st_source_bfm.sv"
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_reset_source.sv" 
  vlog -sv "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/altera_avalon_clock_source.sv" 
  vlog     "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/submodules/st_bfm_qsys_tutorial.v"        
  vlog     "$QSYS_SIMDIR/st_bfm_qsys_tutorial_tb/simulation/st_bfm_qsys_tutorial_tb.v"                
}
