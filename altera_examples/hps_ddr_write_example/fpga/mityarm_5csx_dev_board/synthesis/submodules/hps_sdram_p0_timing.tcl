...
set board(abs_max_DQS_delay) 0.2
set board(minCK_DQS_skew) 0.092
set board(maxCK_DQS_skew) 0.215
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.0
set board(inter_DQS_group_skew) 0.01
set board(DQ_DQS_skew) 0.0
set board(intra_addr_ctrl_skew) 0.0
