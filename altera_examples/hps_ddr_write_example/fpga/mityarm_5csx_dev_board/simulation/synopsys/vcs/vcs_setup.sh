...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0_hps_io_border_memory.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0_hps_io_border_hps_io.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0_hps_io_border.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1_id_router.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1_addr_router.sv \
  ...
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_cmd_xbar_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_id_router_002.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_id_router.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0_addr_router.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_axi_master_ni.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0_hps_io.v \
  ...
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_addr_router.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_addr_router_001.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_cmd_xbar_mux_001.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_id_router.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_id_router_001.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/hps_sdram_mm_interconnect_1_rsp_xbar_mux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0_fpga_interfaces.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_1.v \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_mm_interconnect_0.v \
  ...
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_sysid_qsys.vo \
  $QSYS_SIMDIR/submodules/mityarm_5csx_dev_board_hps_0.v \
  $QSYS_SIMDIR/mityarm_5csx_dev_board.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
