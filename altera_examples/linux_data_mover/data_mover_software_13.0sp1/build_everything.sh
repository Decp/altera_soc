...
BUILD_APPLICATION data_mover_app
BUILD_APPLICATION smp_data_copy
BUILD_APPLICATION amp_sim_data_copy
BUILD_MODULE data_mover_module
BUILD_MODULE amp_sim_module
