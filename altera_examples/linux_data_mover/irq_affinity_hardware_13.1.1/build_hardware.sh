...
EXPECTED_QUARTUS_VERSION="Version 13.1.1 Build 166"
...
FILE_MUST_EXIST "./${TOP_QSYS_SYSTEM_NAME}/synthesis/submodules/${TOP_QSYS_SYSTEM_NAME}_mm_interconnect_0.v"
...
preliminary timing model status in the 13.1 tools.
EOF
