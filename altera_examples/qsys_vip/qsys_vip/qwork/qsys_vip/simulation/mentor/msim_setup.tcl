...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/qsys_vip_tb.sv"                                -L altera_common_sv_packages
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L slave_bfm_s0_translator -L master_bfm_m0_translator -L rst_controller -L mm_interconnect_0 -L slave_bfm -L master_bfm -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
